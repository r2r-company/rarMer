"""
Django settings for rarMer project.
...
SECRET_KEY = 'django-insecure-1y9wkt@8dajz*24#fp7m1m#jl95t&o^2&k-i^!_5a#e*3f=5bt'
...
WSGI_APPLICATION = 'rarMer.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    'workers.ldap_backend.LDAPBackend',  # Замість 'path.to.your' введіть шлях до вашого бекенду
